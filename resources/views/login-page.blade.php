      ...
      >
        <div class="d-flex flex-column justify-content-between py-3">
          <span class="fw-bold text-dark fs-4 d-flex justify-content-center"
            >FORM LOGIN</span
          >
          <div class="form px-4 mt-5">
            <form action="{{ route('todos-page') }}">
            <div class="d-flex flex-column gap-3">
                ...
                <a href="register.php" class="d-flex justify-content-center mt-1"><span>Belum Memiliki Account ? </span>Register</a>
              </div>
            </form>
        </div>
      </div>
